---
title: Como crear la bandera de Colombia con HTML y CSS - Muy fácil
excerpt: El día de hoy les enseñaré como crear la bandera de Colombia usando tan solo HTML y CSS con pocas líneas de código.
date: 2021-06-19
---
